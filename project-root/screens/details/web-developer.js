...
const Image12 = require("../../../assets/wd.jpg");
            ...
            <>
                <View style={styles.container}>
                    <View style={styles.coverPhotoContainer}>
                        <Image source={Image12} style={styles.coverPhoto} />
                    </View>

                    <View style={styles.contentContainer}>
                        <View style={styles.headerContainer}>
                            <View style={styles.imageContainer}>
                                <Image source={Image3} style={styles.image} resizeMode="cover"/>
                            </View>
                            <View style={styles.headerContainer2}>
                                <Text style={styles.headerTextTitle}>Web Developer</Text>
                        ...
                        {activeTab === "Description" && (
                            <View>
                                ...
                                Graphic Designer jobs in the Philippines involve providing 
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.buttonContainer}>
                <DetailsComponents pageKey="Web Developer"/>
            </View>
        </View>
    );
};
