...
const Image10 = require("../../../assets/fl2.jpg");
            ...
            <>
                <View style={styles.container}>
                    <View style={styles.coverPhotoContainer}>
                        <Image source={Image10} style={styles.coverPhoto} />
                    </View>
                    ...
                    <View style={styles.contentContainer}>
                        <View style={styles.headerContainer}>
                            ...
                            <View style={styles.headerContainer2}>
                                <Text style={styles.headerTextTitle}>Freelancing</Text>
                        ...
                        {activeTab === "Description" && (
                            <View>
                                ...
                                Freelancing jobs in the Philippines involve providing 
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.buttonContainer}>
                <DetailsComponents pageKey="Freelancing"/>
            </View>
        </View>
    );
};
