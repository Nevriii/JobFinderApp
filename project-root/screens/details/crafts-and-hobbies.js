                    ...
                    <View style={styles.contentContainer}>
                        <View style={styles.headerContainer}>
                            ...
                            <View style={styles.headerContainer2}>
                                <Text style={styles.headerTextTitle}>Crafts and Hobbies</Text>
                        ...
                        {activeTab === "Description" && (
                            <View>
                                ...
                                Crafts and Hobbies jobs in the Philippines involve providing 
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.buttonContainer}>
                <DetailsComponents pageKey="Crafts and Hobbies"/>
            </View>
        </View>
    );
};
...
export default CraftsAndHobbies;